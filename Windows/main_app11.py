...
def login_button_event(entry_login, entry_pass, app11):
...
def create_main_window1():
    ...
    button_login = customtkinter.CTkButton(entry_frame, text="Log in", command=lambda: login_button_event(entry_login, entry_pass, app11))
